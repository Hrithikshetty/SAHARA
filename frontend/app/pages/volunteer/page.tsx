      ...
      <div className="w-1/2 space-y-8">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="pb-10 pt-10 flex space-x-2">
            <Button type="button"  className=" bg-white text-black" onClick={getLocation}  variant="white">
              Submit Location
            </Button>
            <span>
          ...
          <Button type="submit"  disabled={isLoading} className="w-full bg-white text-black" variant="white">
            Sign up
          </Button>
        </form>
      </div>
