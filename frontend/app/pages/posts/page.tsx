...
const Component: React.FC = () => {
  ...
  return (
    <div className="bg-white text-black px-4 py-6 md:px-6 lg:py-12">
      ...
      <div className="w-full gap-x-96 ">
      <h1 className="text-9xl font-extrabold">SA<span className="text-red-500">HARA </span> </h1>
        ...
        <div className="border-black-100 flex justify-center align-center">
        <div className=" w-4/6">
          {posts.map((post) => (
