export const NAV_LINKS = [
  ...
  { href: '/pages/volunteer', key: 'Volunteer_registration', label: 'Volunteer' },
  { href: '/pages/posts', key: 'Posts', label: 'Posts' },
  { href: '/pages/gioloc', key: 'analysis ', label: 'Analysis' },
  { href: '/pages/relocate-vol', key: 'relocate_vol', label: 'Relocate volunteer' },
];
...
export const FOOTER_LINKS = [
  ...
  {
    title: 'Our Community',
    links: ['sahara analysis', 'Sahara helps', 'sahara'],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: 'Email Officer', value: 'Sahara@help.com' },
  ],
};
